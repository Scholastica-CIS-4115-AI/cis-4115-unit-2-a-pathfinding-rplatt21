...
/**
 * The AreaMap class defines a graph representing a map of Duluth, MN. See
 * Duluth-Map--pathfinding.jpg for image
 *
...
public class AreaMap {
    ...
    private ArrayList<Node> map;            // list of nodes that make up the map
    private int startNode = 0;              // start node for the map
    private int goalNode = 0;               // goal or end node

    /**
     * This constructor creates the fixed map nodes
     */
    public AreaMap() {
        createMap();
    ...
    /**
     * createMap() creates all the nodes in the map and sets their x,y coordinates
     */
    ...
    /**
     * setBothNeighbors() Since roads are not one way, creates graph edge in both directions between two nodes
     * @param n1 and n2 are the two nodes to connect
     * @param dist is the distance between the two nodes.
     */
    ...
    /**
     * getNodes() returns the arraylist of nodes 
     *
    ...
    /**
     * getNodes() access a given node by its index
     *
    ...
    /**
     * setStartLocation() clears previous start node and sets new one
     */
    ...
    /**
     * setGoalLocation() clears previous goal node and sets new one
     */
    ...
    /**
     * getDistanceBetween() estimates the distance between two nodes using
     *    the standard Euclidean 
     *
     * @param a and b are the two nodes to measure the distance between
    ...
    /**
     * printMap() Prints the nodes out. In the future this could display the map graphically
     */
